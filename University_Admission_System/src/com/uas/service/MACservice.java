 ...
 * 
 * MAC Service Interface This is the service layer for the MAC architecture,
 * with methods for showing applicants details, updating their status or
 * interview date, deleting applicant, and showing status.
 * 
 * 
 *
 * @version 1.0
